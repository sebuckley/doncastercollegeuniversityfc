				...
				if ($rowplayerimg['status'] == 1) {
						...
						$playerimage = $playerid.".".$ext;
							...
							echo "<h2 style='text-align:center;'>".$row['teamname']."</h2><br>";
								...
								echo "<input type='text' hidden name='playerid' value='".$row['playerid']."'>";
						
							echo "<img style='display:block;margin-left:auto;margin-right:auto;width:200px;' src='../images/playerimages/player".$playerimage."' width='150px' height='auto' ><br>";
							...
							echo "<input type='text' readonly name='lastname' value=''>";
							echo "<input type='text' name='playersnickname' value='".$row['playersnickname']."'>";
							...
							echo "<input type='text' readonly name='dob' value='$number'>";
							...
							echo "<input type='text' hidden name='playerid' value='".$row['playerid']."'>";
							echo "<iput type='text' name='playerid' readonly value='".$row['position']."'>";
							
							
							
					
							echo "<input type='text' hidden name='playerid' value='".$row['playerid']."'>";
									echo "<input list='position' name='position' value'".$row['position']." '>
